In order to say that one begins something starts a pattern `verb + 始める (はじめる)` is used (translation of the verb is *to begin* or *to start*). A verb which is modified with *始める* must be in its stem form.
