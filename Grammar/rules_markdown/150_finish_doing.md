In order to say that someone completes something (transitive) or something completes (intransitive) verbs `上げる (あげる)` and `上がる (あがる)` are used respectively after the stem form of a verb.
